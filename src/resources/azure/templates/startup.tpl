...
# install gcloud
mkdir -p /opt/google
curl "https://dl.google.com/dl/cloudsdk/channels/rapid/downloads/google-cloud-cli-418.0.0-linux-x86_64.tar.gz" -o "/opt/google/google-cloud-cli-linux-x86_64.tar.gz"
